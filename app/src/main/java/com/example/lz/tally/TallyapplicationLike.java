...
public class TallyapplicationLike extends DefaultApplicationLike{
    ...
    public void onCreate() {
        ...
        Bugly.init(getApplication(), "39b2adb4e3", true);
        SpeechUtility.createUtility(getApplication(), "appid=" + "5859e4bf");
    }
